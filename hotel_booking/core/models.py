...
class RoomType(TimestampedModel):
    ...
    featured_image = models.URLField(blank=True, help_text='Main image URL for this room type')
...
class RoomImage(TimestampedModel):
    ...
    image_alt_text = models.CharField(max_length=255, help_text='Alt text for accessibility')
